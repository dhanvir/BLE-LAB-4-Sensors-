...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[23] }, /* CapSense Slider Characteristic */
    ...
    { 0x0004u, (void *)&cyBle_attValues[39] }, /* RGB LED Characteristic */
    { 0x000Fu, (void *)&cyBle_attValues[43] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x14u] = {
    ...
    { 0x0013u, 0xCBB1u /* RGB LED Characteristic              */, 0x00000A04u /* rd,wr  */, 0x0014u, {{0x0004u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2901u /* Characteristic User Description     */, 0x00000201u /* rd     */, 0x0014u, {{0x000Fu, (void *)&cyBle_attValuesLen[9]}} },
};
